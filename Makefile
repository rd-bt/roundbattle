...
list: list.c moves.c battle-core.c locale.c strmap.c species.c info.c moves.h battle-core.h locale.h strmap.h species.h info.h
	$(CC) $(CFLAG) list.c moves.c battle-core.c locale.c strmap.c species.c info.c -lm -o list
.PHONY:
clean:
	rm -f rdbt nbtdump nbtedit list
