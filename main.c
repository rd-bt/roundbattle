...
#include <string.h>
#include <time.h>
const char *moves[]={"steel_flywheel","absolutely_immortal","freezing_roaring","super_scissors","scorching_roaring","spi_fcrack","natural_shield","spi_shattering_slash",NULL};
